...
function s.spcostfilter(c)
	return c:IsRace(RACE_CYBERSE) and c:IsLocation(LOCATION_GRAVE) and c:IsAbleToRemoveAsCost()
end
function s.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local rg=Duel.GetMatchingGroup(s.spcostfilter,tp,LOCATION_GRAVE,0,e:GetHandler())
